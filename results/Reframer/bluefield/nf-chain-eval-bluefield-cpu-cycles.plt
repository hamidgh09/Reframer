...
set output "nf-chain-eval-bluefield-cpu-cycles.pdf"
...
input_file_nf_chain_cycles_reframer = "data/ReframerUSEFUL-CYCLES-PP.csv"
...
set arrow heads back filled from 64,4105 to 64,6088 ls 1 linewidth 3
set label '-35%' at 45.2,5100 textcolor ls 1

set arrow heads back filled from 256,3820 to 256,6190 ls 1 linewidth 3
set label '-40%' at 237.2,5100 textcolor ls 1
