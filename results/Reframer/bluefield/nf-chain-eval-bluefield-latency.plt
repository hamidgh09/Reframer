...
set output "nf-chain-eval-bluefield-latency.pdf"
...
input_file_nf_chain_latency_reframer = "data/ReframerLATENCY.csv"
...
set arrow heads back filled from 64,610 to 64,675.5 ls 1 linewidth 3
set label '-13%' at 45.0,638 textcolor ls 1

set arrow heads back filled from 112,595 to 112,675.5 ls 1 linewidth 3
set label '-14%' at 93,638 textcolor ls 1
