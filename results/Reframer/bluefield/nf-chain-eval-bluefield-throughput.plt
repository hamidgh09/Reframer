...
set output "nf-chain-eval-bluefield-throughput.pdf"
...
input_file_nf_chain_tput_reframer = "data/ReframerTHROUGHPUT.csv"
...
set arrow heads back filled from 64,3.26 to 64,4.81 ls 1 linewidth 3
set label '+53%' at 43.5,4.075 textcolor ls 1

set arrow heads back filled from 256,3.17 to 256,5.04 ls 1 linewidth 3
set label '+64%' at 235.7,4.075 textcolor ls 1
