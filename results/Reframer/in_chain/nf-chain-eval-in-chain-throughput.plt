...
set output "nf-chain-eval-in-chain-throughput-multi-core.pdf"
...
### Input files
input_file_nf_chain_tput_baseline = "csv/BaselineDUT-THROUGHPUT.csv"
input_file_nf_chain_tput_reframer = "csv/Reframer-mergedDUT-THROUGHPUT.csv"
...
set arrow heads back filled from 64,32.5 to 64,50.5 ls 1 linewidth 3
set label '+60%' at 43,42 textcolor ls 1

# set arrow heads back filled from 256,2.654 to 256,3.68 ls 1 linewidth 3
# set label '+42%' at 235.6,3.10 textcolor ls 1

plot \
	input_file_nf_chain_tput_baseline using ($1):($4):($3):($5) with errorbars ls 1 title "Baseline",\
	input_file_nf_chain_tput_reframer using ($1):($4):($3):($5) with errorbars ls 2 title "With Reframer"
