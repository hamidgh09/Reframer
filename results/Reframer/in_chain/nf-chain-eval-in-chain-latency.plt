...
set output "nf-chain-eval-in-chain-latency-multi-core.pdf"
...
### Input files
input_file_nf_chain_latency_baseline = "latency-data/BaselineLATENCY.csv"
input_file_nf_chain_latency_reframer = "latency-data/Reframer-mergedLATENCY.csv"
...
set arrow heads back filled from 64,297.3 to 64,160 ls 1 linewidth 3
set label '-46%' at 65,210 textcolor ls 1

set arrow heads back filled from 16,287.4 to 16,131.5 ls 1 linewidth 3
set label '-54%' at 17,210 textcolor ls 1
