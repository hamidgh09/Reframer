...
set output "nf-chain-eval-in-chain-cpu-cycles-multi-core.pdf"
...
### Input files
input_file_nf_chain_cycles_baseline = "csv/BaselineUSEFUL-CYCLES-PP.csv"
input_file_nf_chain_cycles_reframer = "csv/Reframer-mergedUSEFUL-CYCLES-PP.csv"
...
set arrow heads back filled from 64,4220 to 64,6400 ls 1 linewidth 3
set label '-36%' at 45.5,5200 textcolor ls 1

# set arrow heads back filled from 256,5251 to 256,7415 ls 1 linewidth 3
# set label '-31%' at 237.5,6580 textcolor ls 1

plot \
	input_file_nf_chain_cycles_baseline using ($1):($4):($3):($5) with errorbars ls 1 title "Baseline",\
	input_file_nf_chain_cycles_reframer using ($1):($4):($3):($5) with errorbars ls 2 title "With Reframer"
