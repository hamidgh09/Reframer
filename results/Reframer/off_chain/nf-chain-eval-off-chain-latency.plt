...
set output "nf-chain-eval-off-chain-latency-multicore.pdf"
...
### Input files
input_file_nf_chain_latency_baseline = "data/BaselineLATENCY.csv"
input_file_nf_chain_latency_reframer_16us = "data/Reframer-16LATENCY.csv"
input_file_nf_chain_latency_reframer_64us = "data/Reframer-64LATENCY.csv"
input_file_nf_chain_latency_reframer_128us = "data/Reframer-128LATENCY.csv"
...
set arrow heads back filled from 30.5,360 to 30.5,598.5 ls 1 linewidth 3
set label '-40%' at 28.5,475 textcolor ls 1

plot \
	input_file_nf_chain_latency_baseline       using ($1):($4):($3):($5) with errorbars ls 1 title "Baseline",\
	input_file_nf_chain_latency_reframer_16us  using ($1):($4):($3):($5) with errorbars ls 3 title "With Reframer (T_{buff}=  16 μs)",\
	input_file_nf_chain_latency_reframer_64us  using ($1):($4):($3):($5) with errorbars ls 2 title "With Reframer (T_{buff}=  64 μs)",\
	input_file_nf_chain_latency_reframer_128us using ($1):($4):($3):($5) with errorbars ls 4 title "With Reframer (T_{buff}=128 μs)"
