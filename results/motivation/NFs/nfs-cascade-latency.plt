...
set output "nfs-cascade-latency.pdf"
...
### Input files
input_file_firewall_caching_off = "data/firewall-caching-off/latency.stats"
input_file_firewall_caching_on = "data/firewall-caching-on/latency.stats"
input_file_nat = "data/nat/latency.stats"
