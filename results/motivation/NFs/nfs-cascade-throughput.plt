...
set output "nfs-cascade-throughput.pdf"
...
### Input files
input_file_firewall_caching_off = "data/firewall-caching-off/throughput.stats"
input_file_firewall_caching_on = "data/firewall-caching-on/throughput.stats"
input_file_nat = "data/nat/throughput.stats"
...
plot \
	input_file_nat                  using ($1):($3/y_scale):($2/y_scale):($4/y_scale) with errorbars ls 1 title "NAT",\
	input_file_firewall_caching_off using ($1):($3/y_scale):($2/y_scale):($4/y_scale) with errorbars ls 2 title "Firewall - Caching Off",\
	input_file_firewall_caching_on  using ($1):($3/y_scale):($2/y_scale):($4/y_scale) with errorbars ls 3 title "Firewall - Caching On"
