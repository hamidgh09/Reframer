...
set output "iperf-cascade-l1-cache-misses.pdf"
...
### Input files
input_file_l1_misses_lro_off = "data/iperf/lro-off/misses-pp.stats"
input_file_l1_misses_lro_on  = "data/iperf/lro-on/misses-pp.stats"
...
set style line 3 pointtype 4 pointsize points_size linewidth points_lw lt rgb(black)
...
plot \
	input_file_l1_misses_lro_off using ($1):($3):($2):($4) with errorbars ls 1 title "Iperf - LRO Off",\
	input_file_l1_misses_lro_on  using ($1):($3):($2):($4) with errorbars ls 2 title "Iperf - LRO On"
