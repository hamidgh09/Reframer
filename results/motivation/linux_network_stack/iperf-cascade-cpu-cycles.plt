...
set output "iperf-cascade-cpu-cycles.pdf"
...
### Input files
input_file_cpu_cycles_lro_off = "data/iperf/lro-off/cycles-pp.stats"
input_file_cpu_cycles_lro_on  = "data/iperf/lro-on/cycles-pp.stats"
...
set arrow heads back filled from 0.7,4413 to 0.7,9500 ls 1 linewidth 3
set label '-53%' at 0.78,7250 textcolor ls 1
set arrow nohead from 0.7,4412 to 15.7,4412 ls 1 linewidth 3 dt 2

set arrow heads back filled from 16.35,3000 to 16.35,9520 ls 2 linewidth 3
set label '-69%' at 15.16,6500 textcolor ls 2
set arrow nohead from 1.3,9540 to 16.4,9540 ls 2 linewidth 3 dt 2

plot \
	input_file_cpu_cycles_lro_off using ($1):($3):($2):($4) with errorbars ls 1 title "Iperf - LRO Off",\
	input_file_cpu_cycles_lro_on  using ($1):($3):($2):($4) with errorbars ls 2 title "Iperf - LRO On"
