...
set output "nf-chain-cascade-l2-misses.pdf"
...
### Input files
input_file_nf_chain_misses = "data/L2-MISSES-PP.stats"
...
# Y-axis
set ylabel "{/Helvetica:Bold L2 misses per packet}"
set ylabel offset 1.1,0.0
set ytics border in scale 1,0.5 norotate
set ytics mirror 0.4
set yrange [y3:y4]
...
set arrow heads back filled from 32.7,0.64 to 32.7,2.9 ls 1 linewidth 3
set label '>4x' at 30.4,1.6 textcolor ls 1
set arrow nohead from 1.3,2.9 to 32.4,2.9 ls 1 linewidth 3 dt 2

plot \
	input_file_nf_chain_misses using ($1):($3):($2):($4) with errorbars ls 1 title "Router {/Symbol=28 \256} NAT {/Symbol=28 \256} Firewall {/Symbol=28 \256} FC Service Chain"
