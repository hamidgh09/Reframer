...
set output "nf-chain-cascade-llc-misses.pdf"
...
### Input files
input_file_nf_chain_misses = "data/LLC-MISSES-PP.stats"
...
# Y-axis
set ylabel "{/Helvetica:Bold LLC misses per packet}"
...
set arrow heads back filled from 32.7,0.012 to 32.7,0.038 ls 1 linewidth 3
set label '>3x' at 30.4,0.024 textcolor ls 1
set arrow nohead from 1.3,0.0386 to 32.4,0.038 ls 1 linewidth 3 dt 2
